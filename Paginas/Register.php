...
<section class="vh-100 bg-image"
  style="background-image: url('../resources/loquequieras.jpg');">
              ...
              <form>
                ...
                <div class="form-check d-flex justify-content-center mb-5">
                  ...
                  <label class="form-check-label" for="form2Example3g">
                    Acepto todo las condiciones <a href="#!" class="text-body"><u>Termios de servicios</u></a>
                  </label>
                </div>
                ...
                <p class="text-center text-muted mt-5 mb-0">¿Ya tienes una cuenta? <a href="#!"
                    class="fw-bold text-body"><u>Inicia sesion</u></a></p>
